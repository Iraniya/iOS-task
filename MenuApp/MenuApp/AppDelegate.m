...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self._slideController = [[MKDSlideViewController alloc] initWithMainViewController:self.navController];
    ...
    self._slideController.leftViewController = self.leftViewController;
    self._slideController.rightViewController = self.rightViewController;
    
    self.window.rootViewController = self._slideController;
